...
Three outcomes, and the middle one is the one that gets missed: the artifact,
...
a whole manuscript as FAILED. Add signatures to config.TRANSIENT_SIGNATURES freely.
    ...
    for attempt in range(1, attempts + 1):
        ...
        if proc.returncode != 0:
            ...
            if is_quota(detail):
                ...
                # parks a section for a reason that is not the section's fault.
