...
def _prose_contract(budget, sentence_max, long_words, long_share,
    ...
    return [
        ...
        "    events-per-variable threshold\" asks a reader to accept a comparison",
        "    against a value you did not state.",
        "  * Do not predict the future. A reader can act on \"future work should",
        "    test X\" and can only wait for \"X will improve\". Say what the limitation",
        "    means for this paper, or cite whoever forecast it on the record.",
        "  * Write a ratio as numbers, not as a word. \"A third the width\", \"of",
        "    comparable magnitude\", \"an order of magnitude larger\" are measurements,",
        "    and spelling them out is how a wrong one survives. Give both figures.",
        "  * Do not claim equivalence you did not test for. An interval containing",
        "    zero means no difference was DETECTED, not that the two are the same.",
        "    Unless a margin was prespecified, \"parity\", \"equivalent\" and \"as good",
        "    as\" assert what the analysis cannot support. Say \"the two tie\" instead.",
        "  * Report an analysis or do not mention it. \"Available from the",
        "    corresponding author\", \"data not shown\", \"reported separately\" each",
        "    advertise a result the reader cannot check. Saying where the CODE or the",
        "    DATA lives is different, and is required.",
